...
const RepositoryPage = () => {
  ...
  console.log("state --repository page is ", state.repositoryDetails);
    ...
    const fetchRepositoryDetails = async () => {
      try {
        ...
        if (data.repository.status === "SUCCESS") {
          console.log("Inside data repository status === SUCCESS");
          console.log("data.repository is ", data.repository);
          dispatch(addRepositoryDetails(data.repository));
        } else {
          console.log("In else method.");
          router.replace(`/repository-logs/${repositoryId}`);
        }
      } catch (error) {
